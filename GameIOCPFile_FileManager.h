...
#define FILE_ONWRITE_SIGNATURE const int32_t result, const DWORD bytesTransferred, const DWORD bytesToTransfer, const uint8_t* data
#define FILE_ONWRITE_PARAMETERS result, bytesTransferred, bytesToTransfer, data
#define FILE_ONREAD_SIGNATURE const int32_t result, const DWORD bytesTransferred, const DWORD bytesToTransfer, const uint8_t* data
#define FILE_ONREAD_PARAMETERS result, bytesTransferred, bytesToTransfer, data
